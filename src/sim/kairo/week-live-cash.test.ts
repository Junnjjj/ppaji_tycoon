...
const BEFORE_K48: Record<number, readonly number[]> = {
  7: [5637537, 6317268, 7049967, 7819750, 8507281, 9241459],
  42: [5642380, 6380545, 7136962, 7911107, 8678904, 9481735],
  20260818: [5647380, 6414817, 7151433, 7932771, 8724758, 9429191],
};
