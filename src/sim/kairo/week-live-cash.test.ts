...
const LOADED: WeekOptions = {
  ...
  courses: { potentialRevenue: 400_000, upkeep: 30_000, potentialRiders: 40 },
};
 ...
 *
 * **2026-08-25 (Phase 2A) 재기준.** 코스 수입은 이제 잠재 처리량이 아니라 실제 코스
 * 수요를 상한으로 삼는다. 시드 7의 3주차부터 수요가 40명 아래라 코스 수입이 줄었고,
 * 다른 두 시드는 수요가 충분해 기존 값과 같다. 이 검사는 여전히 실시간/결산 항등을 본다.
 *
