...
결정일 2026-08-27. 이 문서는 지형·물의 **시각 방향 승인**을 기록한다. 라이브 채택 승인이
아니며, 아직 존재하지 않는 곡선 해안 에셋의 제작·QA를 통과한 것으로 해석하지 않는다.
...
| 현재 review-only 팩 | `public/assets/kairo-terrain-v3-source/manifest.json` | `2c92c6a61c6c778c6f975dda2095ce89eb5ff1919fa80de740bab25fca419053` |
